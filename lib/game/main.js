...
.defines(function () {
    ...
    GameScreen = ig.Game.extend({
        ...
        init: function () {
            ...
            this.core.players[0].x = this.currentRoom.tiles[(this.player1.tile.y * 10) + this.player1.tile.x].x;
            this.core.players[0].y = this.currentRoom.tiles[(this.player1.tile.y * 10) + this.player1.tile.x].y;
        },
                ...
                //if on a tile in room, check if it's occupiable, then if it's not, move the player there
                    ...
                    for(var i = 0; i < 100; i++){
                        if(!this.currentRoom.tiles[i].occupied && this.currentRoom.tiles[i].isMouseOnTile()) {      //bottom left
                            ...
                            this.core.players[0].x = this.currentRoom.tiles[i].x;
                            this.core.players[0].y = this.currentRoom.tiles[i].y;
