	...
	EntityGameCore = ig.Entity.extend({
		...
		init : function(playerCount) {
            ...
            for(var p = 0; p < this.playerMax; p++) {
            	this.players[p] = p;
                  //Doesn't work, I think I need to "clone" the javascript object which I don't understand
            	//this.players[p] = this.playerJobList[0].entity;
                  //so I just create another object instead for now, but I really want to refer to above list
                  this.players[p] = new EntityPlayerCivilian('');
            }
